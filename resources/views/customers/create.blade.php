...
<div class="max-w-2xl mx-auto fade-in">
    ...
    <div class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Tambah Pelanggan Baru</h3>
        ...
        <form action="{{ route('customers.store') }}" method="POST">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="telepon" value="{{ old('telepon') }}" required placeholder="08123456789"
                        class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-brand-500 outline-none dark:bg-gray-700">
                </div>
                ...
                <div>
                    ...
                    <textarea name="alamat" rows="3" placeholder="Alamat lengkap pelanggan..."
                        class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-brand-500 outline-none dark:bg-gray-700">{{ old('alamat') }}</textarea>
                </div>
            </div>
